...
(function() {
	...
	_urlLog.sheetInit = function(){
		...
		initSheet.Cols = [
						...
						, {Header:"메뉴ID", 			Type:"Text",		SaveName:"menuNo",				MinWidth:50,	Align:"Center", 	Edit:0, Sort:0}
						...
						, {Header:"접근유형",			Type:"Text",		SaveName:"accessType",			MinWidth:40,	Align:"Center", 	Edit:0, Sort:0}
						, {Header:"성공 여부",			Type:"Text",		SaveName:"successYn",			MinWidth:40,	Align:"Center", 	Edit:0, Sort:0}
						, {Header:"실패사유",			Type:"Text",		SaveName:"failRsnText",			MinWidth:40,	Align:"Center", 	Edit:0, Sort:0}
...
//		urlLogSheet.SetFrozenCol(3);
	...
	_urlLog.getList = function(){
		...
		var param = { url : "/system/menu-log-history-detail/read-list"
