...
<%@include file="/WEB-INF/views/common/menu.jsp"%>
		...
		<script type="text/javascript">
			$(document).ready(function(){
				abc.biz.cmm.textmsg.auto.template.initTextMsgTemplateSheet();
				...
				$("#searchBtn").click(function(f) {
					abc.biz.cmm.textmsg.auto.template.doActionTextMsgTemplate("search");
				});
				
				//템플릿 유형 선택에 따른 템플릿명 선택.
				$("#mesgTypeCode").off().on("change", function(f) {
					$("#mesgTmplSeq").val(null);
					abc.biz.cmm.textmsg.auto.template.msgTmplchange($("#frmSearch"), "/noacl");
				});
				...
				$("#rgstBtn").click(function(f) {
					abc.open.popup({
						url 	:	"/cmm/msg/text-template/auto/read-detail-pop",
		...
		<div class="container">
			<div class="content-box">
				...
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">자동 발송 문자 템플릿 관리</h2>
						...
						<table class="tbl-search">
							...
							<tbody>
								<tr>
									...
									<td class="input">
										<input type="text" id="mesgId" name="mesgId" class="ui-input" title="발송코드 입력">
									</td>
								</tr>
								<tr>
