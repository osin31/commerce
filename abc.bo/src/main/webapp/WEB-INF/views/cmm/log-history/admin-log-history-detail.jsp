	...
	<div class="window-wrap">
		...
		<div class="window-content">
			...
			<form id="urlLogForm" name="urlLogForm" method="post" onsubmit="return false;">
				...
				<input type="hidden" id="accessUrl" name="accessUrl" value="<c:out value="${param.accessUrl}"/>">
...
<script type="text/javascript" src="/static/common/js/biz/system/abcmart.system.admin.history.detail.js<%=_DP_REV%>" ></script>