...
<%@include file="/WEB-INF/views/common/menu.jsp" %>
		...
		<script type="text/javascript">
			$(function() {
				$("#save").click(function(f) {
					abc.biz.cmm.forbiddenpwd.save();
				});

				$("#resetBtn").click(function(f) {
					$.form("#forbiddenPwdForm").reset();
				});
		...
		<!-- S : container -->
		<form id="forbiddenPwdForm">
		<div class="container">
			<div class="content-box">
				<!-- S : page-header -->
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">패스워드 금지어</h2>
				...
				<div class="content-header">
					<div class="fl">
						<h3 class="content-title">패스워드 금지어 등록</h3>
					</div>
				</div>
				<!-- E : content-header -->
		...
		<script src="/static/common/js/biz/cmm/abcmart.cmm.forbiddenpwd.js<%=_DP_REV%>"> </script>
