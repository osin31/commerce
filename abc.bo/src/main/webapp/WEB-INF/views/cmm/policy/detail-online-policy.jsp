...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		<c:forEach var="plcySeq" items="${PLCY_SEQ}">
			abc.biz.system.onlinepolicy.getBenefitArea('<c:out value="${plcySeq}" />');
		</c:forEach>
	...
	<input type="hidden" id="plcySeq" name="plcySeq" value="<c:out value="${param.plcySeq}"/>">
						...
						<td class="input">
							...
							<ul class="item-list" id="onlnMemberJoinCpnNoArea">
								<li class="btn">
									...
									<input type="hidden" id="onlnMemberJoinCpnNo" name="onlnMemberJoinCpnNo" value="<c:out value="${DATA.onlnMemberJoinCpnNo}"/>">
								</li>
								<li>
									<span class="subject">[<c:out value="${DATA.onlnMemberJoinCpnNo}"/>] <c:out value="${DATA.onlnMemberJoinCpnName}"/></span>
									<button type="button" class="btn-item-del" id="onlnMemberJoinCpnNoDel" name="onlnMemberJoinCpnNoDel" value="onlnMemberJoinCpnNo">
				...
				<tbody>
					<tr>
						...
						<td class="input">
							...
							<span class="ip-text-box">
								<input type="text" class="ui-input num-unit10000000" title="포인트 입력" maxlength="8" id="memberJoinPointAmt" name="memberJoinPointAmt" value="<c:out value="${DATA.memberJoinPointAmt}"/>">
						...
						<td class="input">
							<!-- S : ip-text-box -->
							<span class="ip-text-box">
								<input type="text" class="ui-input num-unit10000000" title="포인트 입력" maxlength="8" id="firstBuyPointAmt" name="firstBuyPointAmt" value="<c:out value="${DATA.firstBuyPointAmt}"/>">
								<span class="text">Point</span>
							</span>
							<!-- E : ip-text-box -->
						</td>
					...
					<tr>
						...
						<td class="input">
							...
							<span class="ip-text-box">
								...
								<input type="text" class="ui-input num-unit100" title="포인트 비율 입력" maxlength="2" id="buyPointRate" name="buyPointRate" value="<c:out value="${DATA.buyPointRate}"/>">
								<span class="text">% Point</span>
							</span>
							<!-- E : ip-text-box -->
						</td>
							...
							<ul class="ip-box-list">
								<li>
									<span class="ui-rdo">
										...
										<input id="annvrFirstBuyPointPayYn_Y" name="annvrFirstBuyPointPayYn" type="radio" checked="checked" <c:if test="${DATA.annvrFirstBuyPointPayYn eq 'Y'}">checked="checked"</c:if> value="Y">
										<label for="annvrFirstBuyPointPayYn_Y">Point</label>
									</span>
									<!-- S : ip-text-box -->
									<span class="ip-text-box">
										<input type="text" class="ui-input num-unit10" title="배 수 입력" maxlength="2" id="annvrFirstBuyPointMultCount" name="annvrFirstBuyPointMultCount" value="<c:out value="${DATA.annvrFirstBuyPointMultCount}"/>">
								...
								<li>
									<span class="ui-rdo">
										<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
										<input id="annvrFirstBuyPointPayYn_N" name="annvrFirstBuyPointPayYn" type="radio" <c:if test="${DATA.annvrFirstBuyPointPayYn eq 'N'}">checked="checked"</c:if> value="N">
					...
					<tr>
						...
						<td class="input">
							<!-- S : ip-text-box -->
							<span class="ip-text-box">
								<input type="text" class="ui-input num-unit10000000" title="포인트 입력" maxlength="8" id="minUsePointAmt" name="minUsePointAmt" value="<c:out value="${DATA.minUsePointAmt}"/>">
								<span class="text">Point</span>
							</span>
							<!-- E : ip-text-box -->
						</td>
						...
						<td class="input">
							<!-- S : ip-text-box -->
							<span class="ip-text-box">
								<input type="text" class="ui-input num-unit1" title="년 수 입력" maxlength="2" id="pointExtnYearCount" name="pointExtnYearCount" value="<c:out value="${DATA.pointExtnYearCount}"/>">
					...
					<tr>
						...
						<td class="input">
							...
							<span class="ip-text-box full-size">
								...
								<input type="text" class="ui-input num-unit100000" title="포인트 입력" maxlength="8" id="prdtRvwPointAmt" name="prdtRvwPointAmt" value="<c:out value="${DATA.prdtRvwPointAmt}"/>">
								<span class="text">Point / 포토후기</span>
								<input type="text" class="ui-input num-unit100000" title="포인트 입력" maxlength="8" id="photoPrdtRvwPointAmt" name="photoPrdtRvwPointAmt" value="<c:out value="${DATA.photoPrdtRvwPointAmt}"/>">
								<span class="text">Point</span>
							</span>
							<!-- E : ip-text-box -->
							...
							<span class="ip-text-box full-size">
								...
								<input type="text" class="ui-input num-unit100000" title="명 수 입력" maxlength="5" id="monthBestRvwCount" name="monthBestRvwCount" value="<c:out value="${DATA.monthBestRvwCount}"/>">
								<span class="text">명에게</span>
								<input type="text" class="ui-input num-unit100000" title="포인트 입력" maxlength="8" id="monthBestRvwPointAmt" name="monthBestRvwPointAmt" value="<c:out value="${DATA.monthBestRvwCount}"/>">
								<span class="text">Point</span>
							</span>
							<!-- E : ip-text-box -->
						</td>
						...
						<td class="input">
							...
							<span class="ip-text-box">
								...
								<input type="text" class="ui-input num-unit10" title="일 수 입력" maxlength="5" id="onlnSaveTermCount" name="onlnSaveTermCount" value="<c:out value="${DATA.onlnSaveTermCount}"/>">
								<span class="text">일 / 오프라인</span>
								<input type="text" class="ui-input num-unit10" title="일 수 입력" maxlength="8" id="oflnSaveTermCount" name="oflnSaveTermCount" value="<c:out value="${DATA.oflnSaveTermCount}"/>">
						...
						<td class="input" colspan="3">
							...
							<ul class="item-list" id="mbshpMemberJoinCpnNoArea">
								...
								<li class="btn">
									...
									<input type="hidden" id="mbshpMemberJoinCpnNo" name="mbshpMemberJoinCpnNo" value="<c:out value="${DATA.mbshpMemberJoinCpnNo}"/>">
								</li>
								<li>
									<span class="subject">[<c:out value="${DATA.mbshpMemberJoinCpnNo}"/>] <c:out value="${DATA.mbshpMemberJoinCpnName}"/></span>
									<button type="button" class="btn-item-del" id="mbshpMemberJoinCpnNoDel" name="mbshpMemberJoinCpnNoDel" value="mbshpMemberJoinCpnNo">
										<span class="ico ico-item-del"><span class="offscreen">쿠폰 삭제</span></span>
									</button>
								</li>
							</ul>
						...
						<td class="input" colspan="3">
							...
							<ul class="item-list" id="birthDayCpnNoArea">
								<li class="btn">
									...
									<input type="hidden" id="birthDayCpnNo" name="birthDayCpnNo" value="<c:out value="${DATA.birthDayCpnNo}"/>">
								</li>
								<li>
									<span class="subject">[<c:out value="${DATA.birthDayCpnNo}"/>] <c:out value="${DATA.birthDayCpnName}"/></span>
									<button type="button" class="btn-item-del" id="birthDayCpnNoDel" name="birthDayCpnNoDel" value="birthDayCpnNo">
										<span class="ico ico-item-del"><span class="offscreen">쿠폰 삭제</span></span>
									</button>
								</li>
							</ul>
						...
						<td class="input">
							...
							<ul class="item-list" id="artAppLoginCpnNoArea">
								<li class="btn">
									...
									<input type="hidden" id="artAppLoginCpnNo" name="artAppLoginCpnNo" value="<c:out value="${DATA.artAppLoginCpnNo}"/>">
								</li>
								<c:if test="${not empty DATA.artAppLoginCpnNo}">
								<li>
									<span class="subject">[<c:out value="${DATA.artAppLoginCpnNo}"/>] <c:out value="${DATA.artAppLoginCpnName}"/></span>
									<button type="button" class="btn-item-del" id="artAppLoginCpnNoDel" name="artAppLoginCpnNoDel" value="artAppLoginCpnNo">
										<span class="ico ico-item-del"><span class="offscreen">쿠폰 삭제</span></span>
									</button>
								</li>
								</c:if>
						...
						<td class="input">
							...
							<ul class="item-list" id="otsAppLoginCpnNoArea">
								<li class="btn">
									...
									<input type="hidden" id="otsAppLoginCpnNo" name="otsAppLoginCpnNo" value="<c:out value="${DATA.otsAppLoginCpnNo}"/>">
								</li>
								<c:if test="${not empty DATA.otsAppLoginCpnNo}">
								<li>
									<span class="subject">[<c:out value="${DATA.otsAppLoginCpnNo}"/>] <c:out value="${DATA.otsAppLoginCpnName}"/></span>
									<button type="button" class="btn-item-del" id="otsAppLoginCpnNoDel" name="otsAppLoginCpnNoDel" value="otsAppLoginCpnNo">
										<span class="ico ico-item-del"><span class="offscreen">쿠폰 삭제</span></span>
									</button>
								</li>
								</c:if>
						...
						<td class="input">
							...
							<ul class="item-list" id="soldOutCmpnsCpnNoArea">
								<li class="btn">
									...
									<input type="hidden" id="soldOutCmpnsCpnNo" name="soldOutCmpnsCpnNo" value="<c:out value="${DATA.soldOutCmpnsCpnNo}"/>">
								</li>
								<c:if test="${not empty DATA.soldOutCmpnsCpnNo}">
								<li>
									<span class="subject">[<c:out value="${DATA.soldOutCmpnsCpnNo}"/>] <c:out value="${DATA.soldOutCmpnsCpnName}"/></span>
									<button type="button" class="btn-item-del" id="soldOutCmpnsCpnNoDel" name="soldOutCmpnsCpnNoDel" value="soldOutCmpnsCpnNo">
										<span class="ico ico-item-del"><span class="offscreen">쿠폰 삭제</span></span>
									</button>
								</li>
								</c:if>
			...
			<table class="tbl-row">
				...
				<tbody>
					<tr>
						...
						<td class="input" colspan="3">
							<span class="date-box">
								<input type="text" id="plcyApplyYmd" name="plcyApplyYmd" data-role="datepicker" maxlength="10" value="<fmt:formatDate value="${DATA.plcyApplyYmd}" pattern="yyyy.MM.dd"/>" class="ui-cal js-ui-cal" title="시행 일자 선택"/>
							</span>
						</td>
					</tr>
					<tr>
						<th scope="row">작성자</th>
						<td><button href="javascript:void(0);" class="link" id="linkAdmin" value="<c:out value="${DATA.rgsterNo}"/>"><c:out value="${DATA.personalAdminInfo}"/></button></td>
						<th scope="row">작성일시</th>
						<td><fmt:formatDate value="${DATA.rgstDtm}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
					</tr>
				</tbody>
			</table>
			<!-- E : tbl-row -->
