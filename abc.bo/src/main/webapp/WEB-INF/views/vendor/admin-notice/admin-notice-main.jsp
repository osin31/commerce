...
<script type="text/javascript">
	$(function() {
		<%-- 관리자 공지 목록 초기 세팅. --%>
		abc.biz.vendor.adminnotice.initAdminNoticeSheet();
...
// 			$("#searchInputBox").val('');
		...
		$("#registAdminNotice").click(function() {
			location.href = "/vendor/admin-notice/create-form";
		});
		...
		$("#searchBtn").off().on("click", function() {
			abc.biz.vendor.adminnotice.adminnoticeDoAction('search');
			return false;
		});
	...
	function adminnoticeSheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		abc.biz.vendor.adminnotice.adminnoticeSheetOnClick(Row, Col, Value, CellX, CellY, CellW, CellH);
	}
	
	function adminnoticeSheet_OnSaveEnd(Code, Msg, StCode, StMsg, Response){
		abc.biz.vendor.adminnotice.adminnoticeSheetOnSaveEnd(Code, Msg, StCode, StMsg, Response);
 	}
	function adminnoticeSheet_OnRowSearchEnd(row){
		abc.biz.vendor.adminnotice.adminnoticeSheetOnRowSearchEnd(row);
	}
...
<div class="container">
	<div class="content-box">
		...
		<div class="page-header">
			<div class="fl">
				<h2 class="page-title">입점사 관리자 공지 관리</h2>
		...
		<div class="tbl-controller">
			<div class="fl">
				...
				<span class="btn-group">
					<!-- S : 20190114 수정 // 버튼 가이드 변경으로 마크업 수정 -->
					<a href="javascript:abc.biz.vendor.adminnotice.adminnoticeDoAction('delete')" class="btn-sm btn-del" id="deleteAdminNotice">선택 항목 삭제</a>
					<!-- E : 20190114 수정 -->
				</span>
			</div>
			<div class="fr">
