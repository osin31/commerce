...
<script type="text/javascript">
	$(function() {
		...
		$("#saveAdminNoticeBtn").off().on('click', function(el) {
			abc.biz.vendor.adminnotice.createAdminNotice();
		});
		
		// 미리보기버튼 클릭		
		$("#previewBtn").off().on('click', function(el) {
			abc.biz.vendor.adminnotice.popupPreCreateAdminNotice();
		});
	...
	function setSelectedVendors(args) {
		...
		<!-- S : container -->
		<form id="adminNoticeForm" name="adminNoticeForm" method="post" action="/vendor/admin-notice/create" enctype="multipart/form-data">
		<div class="container">
