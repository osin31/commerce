...
<script type="text/javascript">
	$(function() {
		<%-- 관리자 목록 초기 세팅. --%>
		abc.biz.system.admin.admin.initAdminSheet();

		<%-- 검색어가 전화번호일 경우 숫자만 입력되는 이벤트 설정. --%>
		$("#searchKey").change(function(){
			abc.biz.system.admin.admin.searchValueSet();
		});

		<%-- 관리자 목록 조회. --%>
		$("#searchBtn").click(function(){
			abc.biz.system.admin.admin.adminDoAction('search');
		});

		<%-- 권한그룹 변경 팝업 호출. --%>
		$("#selAuthBtn").click(function(){
			abc.biz.system.admin.admin.authGroupUpdate();
		});

		<%-- 등록팝업 호출. --%>
		$("#registBtn").click(function(){
			abc.biz.system.admin.admin.registAdmin();
		});
	...
	function adminSheet_OnClick(Row, Col, Value, CellX, CellY, CellW, CellH) {
		if ( Row != 0) {
			if ( adminSheet.ColSaveName(Col) == "listDisplayName" && Value != "" ) {
				var url = "/system/admin/admin/admin-detail-pop";
				var params = {}
...
<div class="container">
	<div class="content-box">
		...
		<div class="content-header">
			<div class="fl">
				<h3 class="content-title">관리자 검색</h3>
			</div>
		</div>
		<!-- E : content-header -->
		...
		<div class="tbl-controller">
			...
			<div class="fr">
				...
				<a href="#" id="registBtn" class="btn-sm btn-link">등록</a>
				<!-- E : 20190114 수정 -->
			</div>
		</div>
		<!-- E : tbl-controller -->
