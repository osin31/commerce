...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(abc.text.allNull("${param.codeDtlNo}")){
			abc.biz.system.commoncode.upCodeBottomHide("${param.codeDtlNo}");
		}else{
		...
		$("#fReset").off().on('click', function(){
			abc.biz.system.commoncode.upFormReload();
		});
		//정렬순서 숫자만 입력하게 하기
		...
		$("#deleteCodeButton").off().on('click', function(){
			abc.biz.system.commoncode.doAction('removeUpCodeCheck'); 
		});
		//코드 삭제 버튼
		$("#saveCodeButton").off().on('click', function(){
			abc.biz.system.commoncode.doAction('upCodeCheck');
		});
...
<body class="window-scroll-none">
	<div class="window-wrap">
		<div class="window-title">
			<h1 id="codeStatus">상위코드 수정/상세</h1>
		</div>
		<div class="window-content">
			<!-- S : content-header -->
			<div class="content-header">
				<div class="fl">
					<h2 class="content-title">상위코드</h2>
				</div>
				<div class="fr">
					<div class="btn-group">
			...
			<!-- S : tbl-row -->
			<form id="upCodeForm" name="upCodeForm" method="post" onsubmit="return false;"> 
				<table class="tbl-row">
					...
					<tbody>
						<tr>
							<th scope="row">상위정보</th>
							<td colspan="3"><input type="hidden" name="codeField" id="codeField" value="${param.codeField}">${param.codeField}</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td class="input" colspan="3">
								<input type="text" class="ui-input" name="sortSeq" id="sortSeq" maxlength="4" value="${syCodeDetail.getSortSeq()}" maxlength="10" title="정렬순서 입력" placeholder="숫자만 입력">
							</td>
						</tr>
						<tr>
			...
			<div class="tbl-desc-wrap" id="removeCheck">
				<div class="fl">
					<a href="javascript:void(0)" id="deleteCodeButton" class="btn-normal btn-del">삭제</a>
				</div>
			</div>
			<!-- E : tbl-desc-wrap -->
			<!-- E : 20190117 추가  -->
			...
			<div class="window-btn-group">
				<a href="javascript:void(0)" id="saveCodeButton" class="btn-lg btn-save">저장</a>
			</div>
			<!-- E : window-btn-group -->
		</div>
	</div>
