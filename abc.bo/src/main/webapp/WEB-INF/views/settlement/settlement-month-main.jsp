				...
				<div class="tab-wrap">
					...
					<div id="tabContent1" class="tab-content">
						...
						<div class="content-header">
							...
							<div class="fr">
								<div class="btn-group">
									<a href="javascript:void(0);" class="btn-sm btn-func" id="excclcConfirm">정산확정</a>
									<a href="javascript:void(0);" class="btn-sm btn-func" id="excclcErpSend">ERP 전송</a>
						...
						<div class="tbl-controller">
							...
							<div class="fr">
								<a href="javascript:void(0)" id="excclcModify" class="btn-sm btn-save">저장</a>
							</div>
						</div>
									...
									<li>
										<span class="msg-list-info">
											<span class="user-info">
												<span class="user-id"><c:out value="${memoList.loginId}"/></span>
												<span class="user-name">(<c:out value="${memoList.adminName}"/>)</span>
											</span>
											<span class="regist-date-wrap">
												<span class="regist-date">${memoList.rgstDate}</span>
												<input type="hidden" value="${memoList.excclcMemoSeq}">
...
<!-- 							</div> -->
	...
	<!-- E : container -->
<script type="text/javascript" src="/static/common/js/biz/settlement/abcmart.settlement.month.main.js<%=_DP_REV%>"></script>	
