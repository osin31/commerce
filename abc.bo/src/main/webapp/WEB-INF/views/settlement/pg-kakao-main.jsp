		...
		<div class="container">
			<div class="content-box">
				...
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">KAKAO 대사관리</h2>
									...
									<td class="input">
										...
										<ul class="ip-box-list">
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="paymentActionTypeAll" id="paymentActionTypeAll" checked>
													<label for="paymentActionTypeAll">전체</label>
												</span>
											</li>
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="paymentActionTypes" id="paymentActionTypePay" checked value="PAYMENT">
													<label for="paymentActionTypePay">결제</label>
												</span>
											</li>
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="paymentActionTypes" id="paymentActionTypeCancel" checked value="CANCEL">
													<label for="paymentActionTypeCancel">취소</label>
												</span>
											</li>
										</ul>
										<!-- E : ip-box-list -->
				...
				<div class="ibsheet-wrap">
					<div style="width:100%; height:429px;" id="pgKakaoGrid"></div>
				</div>
				<!-- E : ibsheet-wrap -->
			</div>
		</div>
...
<script type="text/javascript" src="/static/common/js/biz/settlement/abcmart.pg.kakao.main.js<%=_DP_REV%>"></script>	
