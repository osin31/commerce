		...
		<div class="container">
			<div class="content-box">
				...
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">NAVER 대사관리</h2>
									...
									<td class="input">
										...
										<ul class="ip-box-list">
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="admissionTypeCodeAll" id="admissionTypeCodeAll" checked>
													<label for="admissionTypeCodeAll">전체</label>
												</span>
											</li>
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="admissionTypeCodes" id="admissionTypeCodesPay" checked value="01">
													<label for="admissionTypeCodesPay">결제</label>
												</span>
											</li>
											<li>
												<span class="ui-chk">
													<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
													<input type="checkbox" name="admissionTypeCodes" id="admissionTypeCodesCancel" checked value="03">
													<label for="admissionTypeCodesCancel">취소</label>
													<input type="hidden" name="admissionTypeCodes" id="admissionTypeCodeCancel1">
												</span>
											</li>
										</ul>
										<!-- E : ip-box-list -->
									...
									<td class="input">
										...
										<div class="opt-keyword-box">
											<select name="srchType" id="srchType" class="ui-sel" title="검색어 타입 선택">
												...
												<option value="payMentId">승인번호</option>
											</select>
				...
				<table class="tbl-col">
					...
					<tbody>
						<tr>
							...
							<td class="text-right" id="totalPay">-</td>
				...
				<div class="ibsheet-wrap">
					<div style="width:100%; height:429px;" id="pgNaverGrid"></div>
				</div>
				<!-- E : ibsheet-wrap -->
			</div>
		</div>
...
<script type="text/javascript" src="/static/common/js/biz/settlement/abcmart.pg.naver.main.js<%=_DP_REV%>"></script>	
