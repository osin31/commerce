...
<script type="text/javascript">
	...
	$(function() {
		<%-- 환불 목록 초기 세팅. --%>
		abc.biz.claim.refundList.initRefundListSheet();
	...
	<div class="content-box">
		...
		<div class="tbl-controller">
			<div class="fl">
				...
				<span class="opt-group">
					<label class="title" for="selModule">선택 항목</label>
					<select class="ui-sel" id="selModule">
						<option>선택</option>
						<option>처리불가</option>
						<option>처리완료</option>
					</select>
					<input type="text" class="ui-input" title="처리불가 사유 입력" placeholder="처리불가 사유 입력">
		...
		<div class="ibsheet-wrap">
			<div id="refundListGrid" style="width:100%; height:429px;">
			</div>
		</div>
		<!-- E : ibsheet-wrap -->
	</div>
...
<script src="/static/common/js/biz/claim/abcmart.claim.refundList.js<%=_DP_REV%>"></script>
