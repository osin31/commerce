...
<%
    ...
    /* = -------------------------------------------------------------------------- = */
%>
	<%@ include file="/WEB-INF/views/sample/payment/cfg/site_conf_inc.jsp" %>
<%
...
<form name="order_info" method="post" action="/noacl/sample/payment/kcpApproval" ><!-- pp_cli_hub.jsp -->
...
<br/><br/>
<!-- 취소정보 입력 form : cancel_info -->
<form name="cancel_info" method="post" action="/noacl/sample/payment/kcpCancel" ><!-- pp_cli_hub.jsp -->
	tno : <input type="text" name="tno" value=""/>
	mod_type : <input type="text" name="mod_type" value="STSC"/>
	<div class="btnset" id="display_pay_button" style="display:block">
		<input name="" type="button" class="submit" value="취소요청" onclick="kcp_cancel(this.form);"/>
	</div>
</form>
