...
$(function(){
	abc.biz.stats.order.realtime.initDeviceStatsSheet();
	...
	<div class="container">
		<form name="form" id="form">
			<input type="hidden" name="typeStats" value="device">
			<div class="content-box">
				<!-- S : page-header -->
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">당일 디바이스별 주문 현황</h2>
				...
				<div class="ibsheet-wrap">
					<div id="currentDeviceStatsGrid" style="width:100%; height:429px;"></div>
				</div>
				<!-- E : ibsheet-wrap -->
			</div>
		</form>
