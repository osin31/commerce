...
<div class="container">
	<div class="content-box">
		...
		<div class="page-header">
			<div class="fl">
				<h2 class="page-title">재입고 알림 서비스 상품별 통계</h2>
...
<script type="text/javascript" src="/static/common/js/biz/stats/abcmart.stats.restock.product.js<%=_DP_REV%>"></script>