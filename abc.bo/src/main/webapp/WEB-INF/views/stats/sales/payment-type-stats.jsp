...
$(function(){
	...
	abc.biz.stats.sales.initPaymentTypeSalesStatsSheet();
});
</script>
<!-- S : container -->
		<div class="container">
		<form name="form" id="form" method="post">
			<input type="hidden" name="typeStats" value="paymentType">
			<div class="content-box">
				<!-- S : page-header -->
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">결제수단별 매출통계</h2>
				...
				<div class="ibsheet-wrap">
					<div id="paymentTypeSaleStatsGrid" style="width:200%; height:429px;"></div>
				</div>
				<!-- E : ibsheet-wrap -->
			</div>
		</form>
