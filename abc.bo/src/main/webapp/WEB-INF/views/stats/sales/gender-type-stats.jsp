...
$(function(){
	...
	abc.biz.stats.sales.initGenderTypeSalesStatsSheet();
});
</script>
<!-- S : container -->
		<div class="container">
			<form name="form" id="form">
				<input type="hidden" name="typeStats" value="genderType">
				<div class="content-box">
					<!-- S : page-header -->
					<div class="page-header">
						<div class="fl">
							<h2 class="page-title">성별 매출 통계</h2>
					...
					<div class="ibsheet-wrap">
						<div id="genderTypeSaleStatsGrid" style="width:100%; height:429px;"></div>
					</div>
					<!-- E : ibsheet-wrap -->
				</div>
			</form>
