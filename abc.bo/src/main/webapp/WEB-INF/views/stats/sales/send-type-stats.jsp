...
$(function(){
	...
	abc.biz.stats.sales.initSendTypeSalesStatsSheet();
});
</script>
<!-- S : container -->
		<div class="container">
		<form name="form" id="form" method="post">
			<input type="hidden" name="typeStats" value="sendType"/>
			<div class="content-box">
				<!-- S : page-header -->
				<div class="page-header">
					<div class="fl">
						<h2 class="page-title">발송처별 매출통계</h2>
									...
									<td class="input" colspan="4">
										...
										<span class="term-date-wrap">
											...
											<select class="ui-sel hidden" title="종료 기간 선택" id="monthToDate" name="monthToDate">
												<c:forEach var="yearData" begin="${thisYear}" end="${thisYear}">
													<c:forEach var="monthData" begin="1" end="${thisMonth}">
														<option value="${yearData}.<fmt:formatNumber value="${monthData}" pattern="00"/>" <c:if test="${yyyyMMData eq yyyyMM}">selected</c:if>>
															${yearData}.<fmt:formatNumber value="${monthData}" pattern="00"/></option>
													</c:forEach>
												</c:forEach>
										...
										<div class="member-grade-list">
											...
											<ul class="ip-box-list">
												<li>
													<span class="ui-chk">
														<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
														<input id="chkEscroTrue" name="chkEscroTrue" value="Y" custom="escrApplyYn" type="checkbox" checked>
												...
												<li>
													<span class="ui-chk">
														<!-- DESC : input id / label for 동일하게 맞춰주세요 -->
														<input id="chkEscroFalse" name="chkEscroFalse" value="N" custom="escrApplyYn" type="checkbox" checked>
				...
				<div class="ibsheet-wrap">
					<div id="sendTypeSaleStatsGrid" style="width:200%; height:429px;"></div>
				</div>
				<!-- E : ibsheet-wrap -->
			</div>
		</form>
