...
<script>
$(function() {
	abc.biz.stats.promotion.promotion.isAdmin = ${isAdmin};
});
</script>
<!-- S : container -->
<div class="container">
	<div class="content-box">
		...
		<div class="page-header">
			<div class="fl">
				<h2 class="page-title">프로모션별 현황 통계</h2>
		...
		<div class="search-wrap">
			...
			<div class="search-inner">
				<table class="tbl-search">
					<caption>검색 테이블이며 사이트 구분, 디바이스 구분, 판매 기간, 프로모션 기간, 프로모션별 검색에 대해 검색합니다.</caption>
					<colgroup>
					...
					<tbody>
						...
						<tr>
							...
							<td class="input" colspan="4">
								...
								<span class="term-date-wrap">
									<select class="ui-sel" title="유형 선택" name="dateKeywordType">
										<option value="order-date">주문일</option>
										<option value="payment-confirm-date">결제확인일</option>
									</select>
									<span class="date-box">
						...
						<tr>
							...
							<td class="input" colspan="4">
								...
								<span class="term-date-wrap">
									...
									<span class="date-box">
										<input type="text" data-role="datepicker" class="ui-cal js-ui-cal" title="시작일 선택" name="promoFromDate">
									</span>
									<span class="text">~</span>
									<span class="date-box">
										<input type="text" data-role="datepicker" class="ui-cal js-ui-cal" title="종료일 선택" name="promoToDate">
									</span>
									<span class="btn-group">
										<a href="javascript:void(0);"   name="perToday"  class="btn-sm btn-func">오늘</a>
										<a href="javascript:void(0);"   name="perWeek"   class="btn-sm btn-func">일주일</a>
						...
						<tr>
							...
							<td class="input">
								<select class="ui-sel" title="유형 선택" name="promoType">
									<option value="">전체</option>
									<c:forEach var="item" items="${codeList.PROMO_TYPE_CODE }">
							...
							<td class="input">
								...
								<div class="opt-keyword-box">
									<select class="ui-sel" title="유형 선택" name="searchKeywordType">
										<option value="promo-name">프로모션명</option>
										<option value="promo-no">프로모션번호</option>
									</select>
		...
		<div class="tbl-desc-wrap border-box">
			<ul class="tbl-desc-list">
				...
				<li>* 프로모션 통계 자료는 당일 발생 매출 데이터는 포함되지 않습니다.</li>
		...
		<div class="ibsheet-wrap">
			<div id="promotionGrid" style="width:100%; height:429px;">
...
<script type="text/javascript" src="/static/common/js/biz/stats/abcmart.stats.promotion.promotion.js<%=_DP_REV%>"></script>