		...
		<div class="window-content">
			...
			<div class="notice-view">
				<div class="notice-header">
					<div class="fl">
						<span class="notice-author" id="adminName"><c:out value="${bdAdminNotice.adminName}"/></span>
					</div>
					<div class="fr">
						<div class="notice-item-info">
							<span class="notice-view-cnt">조회수<span>${bdAdminNotice.hitCount}</span></span>
							<span class="notice-reg-date">등록일<span id="rgstDtm">${bdAdminNotice.nowTime}</span></span>
						</div>
					</div>
				</div>
			...
			<div class="window-btn-group">
				...
				<c:if test="${bdAdminNotice.popupYn eq 'Y' and bdAdminNotice.applySystemType ne 'P'}">
