...
<script type="text/javascript">
	...
	$(function() {
		abc.biz.board.adminnotice.adminNotcSeq = "${bdAdminNotice.adminNotcSeq}";
		abc.biz.board.adminnotice.adminName	   = $("#tdAdminName").text();
		abc.biz.board.adminnotice.rgstDtm	   = $("#tdRgstDtm").text();

		abc.biz.board.adminnotice.applySystemType = "${bdAdminNotice.applySystemType}";
		abc.biz.board.adminnotice.notcTitleText	  = "${bdAdminNotice.notcTitleText}";
		abc.biz.board.adminnotice.popupYn		  = "${bdAdminNotice.popupYn}";
		abc.biz.board.adminnotice.alwaysPopupYn	  = "${bdAdminNotice.alwaysPopupYn}";
		abc.biz.board.adminnotice.popupStartYmd	  = "${bdAdminNotice.popupStartYmd}";
		abc.biz.board.adminnotice.popupEndYmd	  = "${bdAdminNotice.popupEndYmd}";
		abc.biz.board.adminnotice.dispYn		  = "${bdAdminNotice.dispYn}";

		<%-- 관리자 공지 상세 화면 호출시, db칼럼데로 세팅하는 메소드 호출--%>
		abc.biz.board.adminnotice.setAdminNoticeDetail();
		...
		abc.biz.board.adminnotice.prevnotcContText = CKEDITOR.instances.notcContText.getData();

		<%-- 관리자 공지 목록 화면으로 이동 --%>
		$("#btnAdminNotcList").click(function(){
			adminNoticeForm.action="/board/admin-notice";
		...
		$("#modifyAdminNoticeBtn").off().on('click', function(el) {
			abc.biz.board.adminnotice.modifyAdminNotice();
		});
		...
		$("#btnPreview").click(function(){
			abc.biz.board.adminnotice.previewDetail();
		});
...
<%-- 			<input type="hidden" id="applySystemType" name="applySystemType" 	 value="${bdAdminNotice.applySystemType}"/> --%>
			...
			<div class="content-box">
				...
				<div class="content-header">
					...
					<div class="fr">
						<div class="btn-group">
							...
							<a href="#" class="btn-sm btn-func" onclick="abc.biz.board.adminnotice.resetForm()"><i class="ico ico-refresh"></i>초기화</a>
							<!-- E : 20190114 수정 -->
						</div>
					</div>
				</div>
				...
				<div class="tbl-desc-wrap">
					<div class="fl">
						<!-- S : 20190114 수정 // 버튼 가이드 변경으로 마크업 수정 -->
						<a href="javascript:void(0)" class="btn-normal btn-link" id="btnPreview">미리보기</a>
						<!-- E : 20190114 수정 -->
					</div>
					<div class="fr">
						<!-- S : 20190114 수정 // 버튼 가이드 변경으로 마크업 수정 -->
