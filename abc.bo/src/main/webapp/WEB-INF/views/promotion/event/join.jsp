											...
											<ul class="ip-box-list">
												<li>
														<span class="ui-chk">
															...
															<label for="chkAnswer1">미등록</label>
														</span>
													</li>
												<li>
														<span class="ui-chk">
...
<script type="text/javascript" src="/static/common/js/biz/promotion/abcmart.promotion.event.join.js<%=_DP_REV%>"></script>
