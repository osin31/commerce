...
@Data
public class BasePdProduct extends BaseBean implements Serializable {
     ...
     * 설명 : 최초입고일
     */
	private java.sql.Timestamp firstWrhsDay;
	
    /**
     * 이 필드는 Code Generator를 통하여 생성 되었습니다.
     * 설명 : 최종입고일
     */
	private java.sql.Timestamp lastWrhsDay;
     ...
     * 설명 : 출시예정여부
     */
	private String relisTodoYn;
	
    /**
     * 이 필드는 Code Generator를 통하여 생성 되었습니다.
     * 설명 : 출시예정일시
     */
	private java.sql.Timestamp relisTodoDtm;
	
    /**
     * 이 필드는 Code Generator를 통하여 생성 되었습니다.
     * 설명 : 사방넷최종전송여부
     */
	private String sabangnetLastSendYn;
