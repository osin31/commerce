...
import kr.co.abcmart.bo.member.repository.master.base.BaseMbMemberInterestStoreDao;
...
public interface MbMemberInterestStoreDao extends BaseMbMemberInterestStoreDao {
	...
	public List<MbMemberInterestStore> selectMemberInterestStore(String memberNo) throws Exception;
