...
import kr.co.abcmart.bo.vendor.repository.master.base.BaseVdVendorManagerDao;
...
public interface VdVendorManagerDao extends BaseVdVendorManagerDao {
	...
	public short getVndrMngrNoNextVal(VdVendorManager managerParam) throws Exception;
