...
import kr.co.abcmart.bo.system.repository.master.base.BaseSySitePaymentMeansDao;
...
public interface SySitePaymentMeansDao extends BaseSySitePaymentMeansDao {
	...
	public List<SySitePaymentMeans> selectPaymentBySiteNo(SySitePaymentMeans sySitePaymentMeans);

	public void deleteBySiteNo(SySitePaymentMeans sySitePaymentMeans);

	public void insertByMeansSeqMax(SySitePaymentMeans paymentMeans);
