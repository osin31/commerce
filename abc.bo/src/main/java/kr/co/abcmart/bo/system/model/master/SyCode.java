...
import kr.co.abcmart.bo.system.model.master.base.BaseSyCode;
...
@Data
public class SyCode extends BaseSyCode {
	...
	public String getRgsterDpName() {
		return UtilsText.concat(UtilsMasking.loginId(this.rgsterId), Const.L_PAREN, UtilsMasking.userName(this.rgsterName),
				Const.R_PAREN);
	}
	public String getModerDpName() {
		return UtilsText.concat(UtilsMasking.loginId(this.moderId), Const.L_PAREN, UtilsMasking.userName(this.moderName),
				Const.R_PAREN);
	}
