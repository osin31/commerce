...
public class ProductApprovalController extends BaseController {
	...
	public ModelAndView getList(Parameter<?> parameter) throws Exception {
		...
		return forward("/product/approval/approval-list");
	}

	/**
	 * @Desc : 상품승인대상관리 (PO) 목록 조회
	...
	public void searchApprovalProductList(Parameter<PdProductApprovalSearchVO> parameter) throws Exception {
		...
		pdProductApprovalSearchVO.setAtPO("Y");
		pdProductApprovalSearchVO.setMmnyPrdtYn("N");
		pdProductApprovalSearchVO.setVndrNo(LoginManager.getUserDetails().getVndrNo());
	...
	public ModelAndView getDetail(Parameter<PdProduct> parameter) throws Exception {
		...
		return forward("/product/approval/approval-detail-popup");
	}

	/**
	 * @Desc : 상품승인대상관리 (PO) 선택 상품 삭제
	 * @Method Name : delete
	 * @Date : 2019. 4. 3.
	 * @Author : hsjhsj19
	 * @param parameter
	 ...
	 */
	@PostMapping("delete")
	public void delete(Parameter<PdProduct[]> parameter) throws Exception {
		log.debug("상품승인대상관리 (PO) 선택 상품 삭제");
		this.writeJson(parameter, this.productApprovalService.delete(parameter.get()));
	}

	/**
	 * @Desc : 상품승인대상관리 (PO) 승인변경
	 * @Method Name : modify
	 * @Date : 2019. 4. 3.
	 * @Author : hsjhsj19
	 * @param parameter
	...
	public void modify(Parameter<PdProductApprovalHistory[]> parameter) throws Exception {
		log.debug("상품승인대상관리 (PO) 승인변경");
		this.writeJson(parameter, this.productApprovalService.modify(parameter.get()));
	}
